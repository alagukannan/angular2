...
var OnChangeCmp = (function () {
    ...
    __decorate([
        core_1.Input('name')
    ], OnChangeCmp.prototype, "name");
    __decorate([
        core_1.Input('comment')
    ], OnChangeCmp.prototype, "comment");
...
var LifecycleSampleApp4 = (function () {
...
exports.LifecycleSampleApp4 = LifecycleSampleApp4;
